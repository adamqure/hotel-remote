from domain.Entities.EmployeeRoles.BillingAdministrator import BillingAdministrator
...
class RefundPaymentUseCase(UseCase):
    ...
    def execute(self, *args):
        ...
        if any(isinstance(item, BillingAdministrator) for item in user.getRoles()):
            return self._repository.processRefund(reservation)
        else:
